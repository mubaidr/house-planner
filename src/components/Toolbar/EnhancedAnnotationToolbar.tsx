...
const EnhancedAnnotationToolbar: React.FC<EnhancedAnnotationToolbarProps> = ({
  ...
  const handleAutoGenerateDimensions = () => {
    ...
    annotations.autoGenerateDimensions(allElements);
  };
  
  const handleAutoGenerateAreas = () => {
    annotations.calculateRoomAreas(rooms);
  };
  
  const handleAutoGenerateMaterials = () => {
    const allElements = [...walls, ...doors, ...windows, ...stairs, ...roofs];
    annotations.autoGenerateMaterialCallouts(allElements, materials);
  };
        ...
        <Popover open={dimensionSettingsOpen} onOpenChange={setDimensionSettingsOpen}>
          ...
          <PopoverContent className="w-80" align="start">
            <div className="space-y-4">
              ...
              <DimensionControls
                config={annotations.dimensions.length > 0 ? annotations.dimensions[0] : {}}
                isEnabled={true}
                onConfigUpdate={() => {}}
                onToggleEnabled={() => {}}
