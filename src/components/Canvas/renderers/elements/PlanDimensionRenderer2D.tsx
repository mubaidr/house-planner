...
export default function PlanDimensionRenderer2D({
  dimension,
  isSelected,
  scale,
  onSelect,
  onEdit,
}: PlanDimensionRenderer2DProps) {
  ...
  const textWidth = dimensionText.length * PLAN_VIEW_CONFIG.dimensionSettings.textSize * 0.6;
  ...
  const extensionLength = PLAN_VIEW_CONFIG.dimensionSettings.lineExtension * scale;
  // const textOffset = PLAN_VIEW_CONFIG.dimensionSettings.textOffset * scale;
  ...
  return (
    <Group>
      ...
      <Line
        ...
        stroke={PLAN_VIEW_CONFIG.colors.dimension}
        strokeWidth={PLAN_VIEW_CONFIG.lineWeights.dimension * scale}
        listening={false}
      />
      ...
      {/* Dimension arrows */}
      {(() => {
        const arrowSize = PLAN_VIEW_CONFIG.dimensionSettings.arrowSize * scale;
      ...
      <Text
        x={dimensionLine.x}
        y={dimensionLine.y - PLAN_VIEW_CONFIG.dimensionSettings.textSize * scale / 2}
        text={dimensionText}
        fontSize={PLAN_VIEW_CONFIG.dimensionSettings.textSize * scale}
        fontFamily="Arial"
        fill={isSelected ? '#3b82f6' : PLAN_VIEW_CONFIG.colors.dimension}
        align="center"
        offsetX={textWidth / 2}
        width={textWidth}
      ...
      <Line
        ...
        stroke="#ffffff"
        strokeWidth={PLAN_VIEW_CONFIG.dimensionSettings.textSize * scale + 2}
        opacity={0.8}
        listening={false}
      />
      ...
      {isSelected && dimension.dimensionType !== 'linear' && (
        <Text
          x={dimensionLine.x}
          y={dimensionLine.y + PLAN_VIEW_CONFIG.dimensionSettings.textSize * scale + 5}
      ...
      {isSelected && (
        <Text
          x={dimensionLine.x}
          y={dimensionLine.y + PLAN_VIEW_CONFIG.dimensionSettings.textSize * scale + 20}
